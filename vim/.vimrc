...
set t_Co=256                          " 256 色
if has('gui_running')
    set background=dark              " 适应亮色背景
    "set guifont=YaHei\ Consolas\ Hybrid\ 12
    set guifont=Xhei\ Mono.Yuan\ Bold\ 13
    set columns=160
    set lines=50
else
...
let g:UltiSnipsSnippetsDir="~/profile/vim/ultisnips/"
...
"        call setline(1,"<head><meta charset=\"UTF-8\"></head>")
	"else 
		...
		"call append(line(".")+1, "	> Author: weiss") 
		"call append(line(".")+2, "	> Mail: myrthenasters@gmail.com") 
...
func! CompileRunGcc()
	...
	elseif &filetype == 'sh'
		:AsyncRun! time bash %
	elseif &filetype == 'python'
		exec "AsyncRun! python %; time python %"
