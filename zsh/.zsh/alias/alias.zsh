...
# 快速关机、重启
#"alias poweroff='/usr/bin/env sudo /sbin/shutdown -h 0'
#alias halt='poweroff'
#alias reboot='/usr/bin/env sudo /sbin/shutdown -r 0'
# x11nvc 启动vncserver
...
alias mb='musicbox'
alias a2c='sudo systemctl start aria2c'
alias live='you-get -p smplayer http://live.bilibili.com/276715'
